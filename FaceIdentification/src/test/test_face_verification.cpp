...
#ifdef _WIN32
std::string DATA_DIR = "D:/git/SeetaFaceEngine/FaceIdentification/data/";
std::string MODEL_DIR = "D:/git/SeetaFaceEngine/FaceIdentification/model/";
#else
...
int main(int argc, char* argv[]) {
  ...
  seeta::FaceAlignment point_detector("D:/git/SeetaFaceEngine/FaceAlignment/model/seeta_fa_v1.1.bin");
